        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {programs.map((program, idx) => (
            <motion.div
              ...
              className={`card p-8 flex flex-col items-center transition-all duration-200 cursor-pointer ${
            ...
            >
              ...
              <p className="text-slate-600 dark:text-slate-400 text-center">{program.description}</p>
              {!program.enabled && (
